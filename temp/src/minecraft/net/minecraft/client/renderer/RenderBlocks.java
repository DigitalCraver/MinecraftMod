...
public class RenderBlocks {
   ...
   public void func_83020_a(double p_83020_1_, double p_83020_3_, double p_83020_5_, double p_83020_7_, double p_83020_9_, double p_83020_11_) {
      if(!this.field_83023_m) {
         ...
         this.field_98189_n = this.field_83021_g > 0.0D || this.field_83026_h < 1.0D || this.field_83027_i > 0.0D || this.field_83024_j < 1.0D || this.field_83025_k > 0.0D || this.field_83022_l < 1.0D;
      }
   ...
   public boolean func_78612_b(Block p_78612_1_, int p_78612_2_, int p_78612_3_, int p_78612_4_) {
      ...
      return var5 == 0?this.func_78570_q(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 31?this.func_78581_r(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 39?this.func_96445_r(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 4?this.func_78621_p(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 13?this.func_78584_s(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 1?this.func_78620_l(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 19?this.func_78603_m(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 23?this.func_78566_o(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 6?this.func_78614_n(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 2?this.func_78572_c(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 3?this.func_78590_h((BlockFire)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 5?this.func_78589_i(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 8?this.func_78576_j(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 7?this.func_78601_u(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 9?this.func_78586_a((BlockRailBase)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 10?this.func_78565_t((BlockStairs)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 27?this.func_78618_a((BlockDragonEgg)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 11?this.func_78582_a((BlockFence)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 32?this.func_82779_a((BlockWall)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 12?this.func_78594_e(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 29?this.func_78577_f(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 30?this.func_78619_g(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 14?this.func_78574_w(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 15?this.func_78610_x((BlockRedstoneRepeater)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 36?this.func_94176_a((BlockRedstoneLogic)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 37?this.func_94171_a((BlockComparator)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 16?this.func_78593_b(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_, false):(var5 == 17?this.func_78608_c(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_, true):(var5 == 18?this.func_78592_a((BlockPane)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 20?this.func_78598_k(p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 21?this.func_78580_a((BlockFenceGate)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 24?this.func_78615_a((BlockCauldron)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 33?this.func_82780_a((BlockFlowerPot)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 35?this.func_82775_a((BlockAnvil)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 25?this.func_78585_a((BlockBrewingStand)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 26?this.func_78567_v((BlockEndPortalFrame)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 28?this.func_78616_a((BlockCocoa)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 34?this.func_82778_a((BlockBeacon)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):(var5 == 38?this.func_94172_a((BlockHopper)p_78612_1_, p_78612_2_, p_78612_3_, p_78612_4_):false))))))))))))))))))))))))))))))))))))));
   }
   ...
   public boolean func_78621_p(Block p_78621_1_, int p_78621_2_, int p_78621_3_, int p_78621_4_) {
      ...
      if(!var10 && !var11 && !var12[0] && !var12[1] && !var12[2] && !var12[3]) {
         ...
         if(this.field_78661_f || var11) {
            ...
            float var59 = 1.0F;
            var5.func_78386_a(var14 * var59, var14 * var59, var14 * var59);
         ...
         for(int var58 = 0; var58 < 4; ++var58) {
            ...
            Icon var61 = this.func_94165_a(p_78621_1_, var58 + 2, var23);
            if(this.field_78661_f || var12[var58]) {
               ...
               var5.func_78380_c(p_78621_1_.func_71874_e(this.field_78669_a, var60, p_78621_3_, var37));
               float var57 = 1.0F;
               if(var58 < 2) {
                  var57 *= var16;
               } else {
               ...
               var5.func_78386_a(var15 * var57 * var7, var15 * var57 * var8, var15 * var57 * var9);
               var5.func_78374_a(var43, (double)p_78621_3_ + var39, var45, (double)var51, (double)var54);
               var5.func_78374_a(var47, (double)p_78621_3_ + var41, var49, (double)var52, (double)var55);
               var5.func_78374_a(var47, (double)(p_78621_3_ + 0), var49, (double)var52, (double)var56);
               var5.func_78374_a(var43, (double)(p_78621_3_ + 0), var45, (double)var51, (double)var56);
            }
         }
   ...
   public boolean func_78578_a(Block p_78578_1_, int p_78578_2_, int p_78578_3_, int p_78578_4_, float p_78578_5_, float p_78578_6_, float p_78578_7_) {
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ - 1, 2)) {
         if(this.field_78698_am > 0) {
            ...
            if(this.field_98189_n && this.field_94177_n.field_71474_y.field_74348_k >= 2) {
               ...
               var9 = (float)((double)var27 * this.field_83024_j * (1.0D - this.field_83021_g) + (double)var28 * this.field_83027_i * this.field_83021_g + (double)var29 * (1.0D - this.field_83024_j) * this.field_83021_g + (double)var30 * (1.0D - this.field_83024_j) * (1.0D - this.field_83021_g));
               var10 = (float)((double)var27 * this.field_83024_j * (1.0D - this.field_83026_h) + (double)var28 * this.field_83024_j * this.field_83026_h + (double)var29 * (1.0D - this.field_83024_j) * this.field_83026_h + (double)var30 * (1.0D - this.field_83024_j) * (1.0D - this.field_83026_h));
               var11 = (float)((double)var27 * this.field_83027_i * (1.0D - this.field_83026_h) + (double)var28 * this.field_83027_i * this.field_83026_h + (double)var29 * (1.0D - this.field_83027_i) * this.field_83026_h + (double)var30 * (1.0D - this.field_83027_i) * (1.0D - this.field_83026_h));
               var12 = (float)((double)var27 * this.field_83027_i * (1.0D - this.field_83021_g) + (double)var28 * this.field_83027_i * this.field_83021_g + (double)var29 * (1.0D - this.field_83027_i) * this.field_83021_g + (double)var30 * (1.0D - this.field_83027_i) * (1.0D - this.field_83021_g));
               var31 = this.func_78602_a(this.field_78690_ai, this.field_78704_aa, this.field_78703_ad, var22);
               var32 = this.func_78602_a(this.field_78703_ad, this.field_78692_aj, this.field_78709_ae, var22);
               var33 = this.func_78602_a(this.field_78645_V, this.field_78657_X, this.field_78692_aj, var22);
               var34 = this.func_78602_a(this.field_78649_S, this.field_78690_ai, this.field_78645_V, var22);
               this.field_78700_an = this.func_96444_a(var31, var32, var33, var34, this.field_83024_j * (1.0D - this.field_83021_g), this.field_83024_j * this.field_83021_g, (1.0D - this.field_83024_j) * this.field_83021_g, (1.0D - this.field_83024_j) * (1.0D - this.field_83021_g));
               this.field_78694_ao = this.func_96444_a(var31, var32, var33, var34, this.field_83024_j * (1.0D - this.field_83026_h), this.field_83024_j * this.field_83026_h, (1.0D - this.field_83024_j) * this.field_83026_h, (1.0D - this.field_83024_j) * (1.0D - this.field_83026_h));
               this.field_78696_ap = this.func_96444_a(var31, var32, var33, var34, this.field_83027_i * (1.0D - this.field_83026_h), this.field_83027_i * this.field_83026_h, (1.0D - this.field_83027_i) * this.field_83026_h, (1.0D - this.field_83027_i) * (1.0D - this.field_83026_h));
               this.field_78676_aq = this.func_96444_a(var31, var32, var33, var34, this.field_83027_i * (1.0D - this.field_83021_g), this.field_83027_i * this.field_83021_g, (1.0D - this.field_83027_i) * this.field_83021_g, (1.0D - this.field_83027_i) * (1.0D - this.field_83021_g));
            } else {
         ...
         this.field_78665_ay *= var12;
         this.field_78652_aC *= var12;
         var35 = this.func_94170_a(p_78578_1_, this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_, 2);
         this.func_78611_c(p_78578_1_, (double)p_78578_2_, (double)p_78578_3_, (double)p_78578_4_, var35);
         if(field_78667_b && var35.func_94215_i().equals("grass_side") && !this.func_94167_b()) {
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_ + 1, 3)) {
         if(this.field_78698_am > 0) {
            ...
            if(this.field_98189_n && this.field_94177_n.field_71474_y.field_74348_k >= 2) {
               ...
               var28 = (this.field_78693_t + this.field_78635_I + this.field_78633_N + this.field_78636_J) / 4.0F;
               var29 = (this.field_78710_y + this.field_78693_t + this.field_78629_B + this.field_78633_N) / 4.0F;
               var30 = (this.field_78687_w + this.field_78632_M + this.field_78710_y + this.field_78693_t) / 4.0F;
               var9 = (float)((double)var27 * this.field_83024_j * (1.0D - this.field_83021_g) + (double)var28 * this.field_83024_j * this.field_83021_g + (double)var29 * (1.0D - this.field_83024_j) * this.field_83021_g + (double)var30 * (1.0D - this.field_83024_j) * (1.0D - this.field_83021_g));
               var10 = (float)((double)var27 * this.field_83027_i * (1.0D - this.field_83021_g) + (double)var28 * this.field_83027_i * this.field_83021_g + (double)var29 * (1.0D - this.field_83027_i) * this.field_83021_g + (double)var30 * (1.0D - this.field_83027_i) * (1.0D - this.field_83021_g));
               var11 = (float)((double)var27 * this.field_83027_i * (1.0D - this.field_83026_h) + (double)var28 * this.field_83027_i * this.field_83026_h + (double)var29 * (1.0D - this.field_83027_i) * this.field_83026_h + (double)var30 * (1.0D - this.field_83027_i) * (1.0D - this.field_83026_h));
               var12 = (float)((double)var27 * this.field_83024_j * (1.0D - this.field_83026_h) + (double)var28 * this.field_83024_j * this.field_83026_h + (double)var29 * (1.0D - this.field_83024_j) * this.field_83026_h + (double)var30 * (1.0D - this.field_83024_j) * (1.0D - this.field_83026_h));
               var31 = this.func_78602_a(this.field_78686_ak, this.field_78702_ac, this.field_78706_ag, var25);
               var32 = this.func_78602_a(this.field_78706_ag, this.field_78688_al, this.field_78707_ah, var25);
               var33 = this.func_78602_a(this.field_78643_W, this.field_78660_Z, this.field_78688_al, var25);
               var34 = this.func_78602_a(this.field_78639_U, this.field_78686_ak, this.field_78643_W, var25);
               this.field_78700_an = this.func_96444_a(var31, var34, var33, var32, this.field_83024_j * (1.0D - this.field_83021_g), (1.0D - this.field_83024_j) * (1.0D - this.field_83021_g), (1.0D - this.field_83024_j) * this.field_83021_g, this.field_83024_j * this.field_83021_g);
               this.field_78694_ao = this.func_96444_a(var31, var34, var33, var32, this.field_83027_i * (1.0D - this.field_83021_g), (1.0D - this.field_83027_i) * (1.0D - this.field_83021_g), (1.0D - this.field_83027_i) * this.field_83021_g, this.field_83027_i * this.field_83021_g);
               this.field_78696_ap = this.func_96444_a(var31, var34, var33, var32, this.field_83027_i * (1.0D - this.field_83026_h), (1.0D - this.field_83027_i) * (1.0D - this.field_83026_h), (1.0D - this.field_83027_i) * this.field_83026_h, this.field_83027_i * this.field_83026_h);
               this.field_78676_aq = this.func_96444_a(var31, var34, var33, var32, this.field_83024_j * (1.0D - this.field_83026_h), (1.0D - this.field_83024_j) * (1.0D - this.field_83026_h), (1.0D - this.field_83024_j) * this.field_83026_h, this.field_83024_j * this.field_83026_h);
            } else {
         ...
         this.field_78665_ay *= var12;
         this.field_78652_aC *= var12;
         var35 = this.func_94170_a(p_78578_1_, this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_, 3);
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_ - 1, p_78578_3_, p_78578_4_, 4)) {
         if(this.field_78698_am > 0) {
            ...
            if(this.field_98189_n && this.field_94177_n.field_71474_y.field_74348_k >= 2) {
               var27 = (this.field_78689_v + this.field_78687_w + this.field_78673_o + this.field_78632_M) / 4.0F;
               var28 = (this.field_78673_o + this.field_78632_M + this.field_78624_D + this.field_78625_E) / 4.0F;
               var29 = (this.field_78637_K + this.field_78673_o + this.field_78630_C + this.field_78624_D) / 4.0F;
               var30 = (this.field_78691_u + this.field_78689_v + this.field_78637_K + this.field_78673_o) / 4.0F;
               var9 = (float)((double)var28 * this.field_83024_j * this.field_83022_l + (double)var29 * this.field_83024_j * (1.0D - this.field_83022_l) + (double)var30 * (1.0D - this.field_83024_j) * (1.0D - this.field_83022_l) + (double)var27 * (1.0D - this.field_83024_j) * this.field_83022_l);
               var10 = (float)((double)var28 * this.field_83024_j * this.field_83025_k + (double)var29 * this.field_83024_j * (1.0D - this.field_83025_k) + (double)var30 * (1.0D - this.field_83024_j) * (1.0D - this.field_83025_k) + (double)var27 * (1.0D - this.field_83024_j) * this.field_83025_k);
               var11 = (float)((double)var28 * this.field_83027_i * this.field_83025_k + (double)var29 * this.field_83027_i * (1.0D - this.field_83025_k) + (double)var30 * (1.0D - this.field_83027_i) * (1.0D - this.field_83025_k) + (double)var27 * (1.0D - this.field_83027_i) * this.field_83025_k);
               var12 = (float)((double)var28 * this.field_83027_i * this.field_83022_l + (double)var29 * this.field_83027_i * (1.0D - this.field_83022_l) + (double)var30 * (1.0D - this.field_83027_i) * (1.0D - this.field_83022_l) + (double)var27 * (1.0D - this.field_83027_i) * this.field_83022_l);
               var31 = this.func_78602_a(this.field_78641_T, this.field_78639_U, this.field_78686_ak, var20);
               var32 = this.func_78602_a(this.field_78686_ak, this.field_78705_ab, this.field_78702_ac, var20);
               var33 = this.func_78602_a(this.field_78690_ai, this.field_78704_aa, this.field_78705_ab, var20);
               var34 = this.func_78602_a(this.field_78649_S, this.field_78641_T, this.field_78690_ai, var20);
               this.field_78700_an = this.func_96444_a(var32, var33, var34, var31, this.field_83024_j * this.field_83022_l, this.field_83024_j * (1.0D - this.field_83022_l), (1.0D - this.field_83024_j) * (1.0D - this.field_83022_l), (1.0D - this.field_83024_j) * this.field_83022_l);
               this.field_78694_ao = this.func_96444_a(var32, var33, var34, var31, this.field_83024_j * this.field_83025_k, this.field_83024_j * (1.0D - this.field_83025_k), (1.0D - this.field_83024_j) * (1.0D - this.field_83025_k), (1.0D - this.field_83024_j) * this.field_83025_k);
               this.field_78696_ap = this.func_96444_a(var32, var33, var34, var31, this.field_83027_i * this.field_83025_k, this.field_83027_i * (1.0D - this.field_83025_k), (1.0D - this.field_83027_i) * (1.0D - this.field_83025_k), (1.0D - this.field_83027_i) * this.field_83025_k);
               this.field_78676_aq = this.func_96444_a(var32, var33, var34, var31, this.field_83027_i * this.field_83022_l, this.field_83027_i * (1.0D - this.field_83022_l), (1.0D - this.field_83027_i) * (1.0D - this.field_83022_l), (1.0D - this.field_83027_i) * this.field_83022_l);
            } else {
         ...
         this.field_78665_ay *= var12;
         this.field_78652_aC *= var12;
         var35 = this.func_94170_a(p_78578_1_, this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_, 4);
         this.func_78573_e(p_78578_1_, (double)p_78578_2_, (double)p_78578_3_, (double)p_78578_4_, var35);
         if(field_78667_b && var35.func_94215_i().equals("grass_side") && !this.func_94167_b()) {
            this.field_78674_ar *= p_78578_5_;
            this.field_78672_as *= p_78578_5_;
            this.field_78670_at *= p_78578_5_;
      ...
      if(this.field_78661_f || p_78578_1_.func_71877_c(this.field_78669_a, p_78578_2_ + 1, p_78578_3_, p_78578_4_, 5)) {
         if(this.field_78698_am > 0) {
            ...
            if(this.field_98189_n && this.field_94177_n.field_71474_y.field_74348_k >= 2) {
               ...
               var9 = (float)((double)var27 * (1.0D - this.field_83027_i) * this.field_83022_l + (double)var28 * (1.0D - this.field_83027_i) * (1.0D - this.field_83022_l) + (double)var29 * this.field_83027_i * (1.0D - this.field_83022_l) + (double)var30 * this.field_83027_i * this.field_83022_l);
               var10 = (float)((double)var27 * (1.0D - this.field_83027_i) * this.field_83025_k + (double)var28 * (1.0D - this.field_83027_i) * (1.0D - this.field_83025_k) + (double)var29 * this.field_83027_i * (1.0D - this.field_83025_k) + (double)var30 * this.field_83027_i * this.field_83025_k);
               var11 = (float)((double)var27 * (1.0D - this.field_83024_j) * this.field_83025_k + (double)var28 * (1.0D - this.field_83024_j) * (1.0D - this.field_83025_k) + (double)var29 * this.field_83024_j * (1.0D - this.field_83025_k) + (double)var30 * this.field_83024_j * this.field_83025_k);
               var12 = (float)((double)var27 * (1.0D - this.field_83024_j) * this.field_83022_l + (double)var28 * (1.0D - this.field_83024_j) * (1.0D - this.field_83022_l) + (double)var29 * this.field_83024_j * (1.0D - this.field_83022_l) + (double)var30 * this.field_83024_j * this.field_83022_l);
               var31 = this.func_78602_a(this.field_78655_Y, this.field_78660_Z, this.field_78688_al, var23);
               var32 = this.func_78602_a(this.field_78688_al, this.field_78711_af, this.field_78707_ah, var23);
               var33 = this.func_78602_a(this.field_78692_aj, this.field_78709_ae, this.field_78711_af, var23);
               var34 = this.func_78602_a(this.field_78657_X, this.field_78655_Y, this.field_78692_aj, var23);
               this.field_78700_an = this.func_96444_a(var31, var34, var33, var32, (1.0D - this.field_83027_i) * this.field_83022_l, (1.0D - this.field_83027_i) * (1.0D - this.field_83022_l), this.field_83027_i * (1.0D - this.field_83022_l), this.field_83027_i * this.field_83022_l);
               this.field_78694_ao = this.func_96444_a(var31, var34, var33, var32, (1.0D - this.field_83027_i) * this.field_83025_k, (1.0D - this.field_83027_i) * (1.0D - this.field_83025_k), this.field_83027_i * (1.0D - this.field_83025_k), this.field_83027_i * this.field_83025_k);
               this.field_78696_ap = this.func_96444_a(var31, var34, var33, var32, (1.0D - this.field_83024_j) * this.field_83025_k, (1.0D - this.field_83024_j) * (1.0D - this.field_83025_k), this.field_83024_j * (1.0D - this.field_83025_k), this.field_83024_j * this.field_83025_k);
               this.field_78676_aq = this.func_96444_a(var31, var34, var33, var32, (1.0D - this.field_83024_j) * this.field_83022_l, (1.0D - this.field_83024_j) * (1.0D - this.field_83022_l), this.field_83024_j * (1.0D - this.field_83022_l), this.field_83024_j * this.field_83022_l);
            } else {
         ...
         this.field_78665_ay *= var12;
         this.field_78652_aC *= var12;
         var35 = this.func_94170_a(p_78578_1_, this.field_78669_a, p_78578_2_, p_78578_3_, p_78578_4_, 5);
         this.func_78605_f(p_78578_1_, (double)p_78578_2_, (double)p_78578_3_, (double)p_78578_4_, var35);
         if(field_78667_b && var35.func_94215_i().equals("grass_side") && !this.func_94167_b()) {
            this.field_78674_ar *= p_78578_5_;
            this.field_78672_as *= p_78578_5_;
            this.field_78670_at *= p_78578_5_;
