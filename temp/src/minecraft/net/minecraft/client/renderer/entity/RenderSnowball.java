...
public class RenderSnowball extends Render {
   ...
   public void func_76986_a(Entity p_76986_1_, double p_76986_2_, double p_76986_4_, double p_76986_6_, float p_76986_8_, float p_76986_9_) {
      if(this.field_77027_a == null) {
         this.field_77027_a = this.field_94151_a.func_77617_a(this.field_94150_f);
      }
      ...
      if(this.field_77027_a == ItemPotion.func_94589_d("potion_splash")) {
         ...
         GL11.glPushMatrix();
         this.func_77026_a(var10, ItemPotion.func_94589_d("potion_contents"));
         GL11.glPopMatrix();
