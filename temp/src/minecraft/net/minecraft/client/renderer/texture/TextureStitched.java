...
public class TextureStitched implements Icon {
   ...
   public void func_94218_a(Texture p_94218_1_, List p_94218_2_, int p_94218_3_, int p_94218_4_, int p_94218_5_, int p_94218_6_, boolean p_94218_7_) {
      ...
      this.field_94231_l = (float)p_94218_3_ / (float)p_94218_1_.func_94275_d();
      this.field_94232_m = (float)(p_94218_3_ + p_94218_5_) / (float)p_94218_1_.func_94275_d();
      this.field_94229_n = (float)p_94218_4_ / (float)p_94218_1_.func_94276_e();
      this.field_94230_o = (float)(p_94218_4_ + p_94218_6_) / (float)p_94218_1_.func_94276_e();
   ...
   public float func_94214_a(double p_94214_1_) {
      ...
      return this.field_94231_l + var3 * ((float)p_94214_1_ / 16.0F) - Float.MIN_VALUE;
   }
   ...
   public float func_94207_b(double p_94207_1_) {
      ...
      return this.field_94229_n + var3 * ((float)p_94207_1_ / 16.0F) - Float.MIN_VALUE;
   }
