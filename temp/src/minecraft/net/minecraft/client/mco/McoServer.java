...
public class McoServer extends ValueObject implements Comparable {
   ...
   public void func_96401_a(McoServer p_96401_1_) {
      ...
      this.field_96416_i = p_96401_1_.field_96416_i;
   ...
   public int func_101017_b(McoServer p_101017_1_) {
      if(this.field_96405_e.equals(p_101017_1_.field_96405_e)) {
         return this.field_96408_a < p_101017_1_.field_96408_a?1:(this.field_96408_a > p_101017_1_.field_96408_a?-1:0);
      } else {
         if(this.field_96404_d.equals("CLOSED") || p_101017_1_.field_96404_d.equals("CLOSED")) {
            if(this.field_96404_d.equals("CLOSED")) {
               return 1;
            }

            if(p_101017_1_.field_96404_d.equals("CLOSED")) {
               return 0;
            }
         }
   ...
   public int compareTo(Object p_compareTo_1_) {
      return this.func_101017_b((McoServer)p_compareTo_1_);
   }
}
