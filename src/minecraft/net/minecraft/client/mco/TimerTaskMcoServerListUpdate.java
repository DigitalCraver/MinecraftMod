...
class TimerTaskMcoServerListUpdate extends TimerTask
{
    ...
    private void func_101018_a(List par1List)
    {
        ...
        while (iterator.hasNext())
        {
            ...
            if (mcoserver.field_96405_e.equals(McoServerList.func_100014_a(this.field_98261_b).username))
            {
                arraylist.add(mcoserver);
            }
            else
            {
                arraylist1.add(mcoserver);
            }
        }
        ...
        par1List.clear();
        par1List.addAll(arraylist);
        par1List.addAll(arraylist1);
    }
