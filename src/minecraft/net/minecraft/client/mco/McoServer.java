...
public class McoServer extends ValueObject implements Comparable
{
    ...
    public int func_101017_b(McoServer par1McoServer)
    {
        if (this.field_96405_e.equals(par1McoServer.field_96405_e))
        {
            return this.field_96408_a < par1McoServer.field_96408_a ? 1 : (this.field_96408_a > par1McoServer.field_96408_a ? -1 : 0);
        }
        else
        {
            if (this.field_96404_d.equals("CLOSED") || par1McoServer.field_96404_d.equals("CLOSED"))
            {
    ...
    {
        return this.func_101017_b((McoServer)par1Obj);
    }
}
